...
public class NativeIO {
    ...
    public static FileOutputStream getCreateForWriteFileOutputStream(File f, int permissions) throws IOException {
        ...
        if (!Shell.WINDOWS) {
            try {
                fd = POSIX.open(f.getAbsolutePath(), POSIX.O_WRONLY | POSIX.O_CREAT | POSIX.O_EXCL, permissions);
    ...
    public static class POSIX {
        ...
        public static void setPmdkSupportState(int stateCode) {
            SupportState[] var1 = SupportState.values();
        ...
        static {
            pmdkSupportState = SupportState.UNSUPPORTED;
